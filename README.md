...
| targeted_MSH2 |  Parses count files of a MSH2 hotspot variant from [nf-cmgg/report](https://github.com/nf-cmgg/report) pipeline to make a report in MultiQC. To use module add `-m/--module targeted_MSH2` and `-c/--config <path_to_multiqc_config_targeted_MSH2.yaml>` |
